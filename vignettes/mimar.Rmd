...
i_rf <- impute(dat, imputer = rf_spec, m = 3, maxit = 3, seed = 1)
i_xgb <- impute(dat, imputer = xgb_spec, m = 3, maxit = 3, seed = 1)
i_knn <- impute(dat, imputer = "knn", m = 3, maxit = 3, seed = 1, donors = 10)
