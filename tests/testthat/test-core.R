test_that("describe data frames and imputers", {
  ...
  expect_equal(d$n, 3)
  expect_equal(d$p, 2)
  expect_s3_class(d$variable_summary, "basetable")
  expect_s3_class(d$row_summary, "basetable")
  expect_s3_class(d$pattern, "basetable")
...
test_that("ampute mechanisms work", {
  ...
  expect_s3_class(mcar$data, "basetable")
  expect_s3_class(mcar$mask_added, "basetable")
  expect_s3_class(summary(mcar), "basetable")
...
test_that("naive imputation works", {
  ...
  expect_s3_class(i1$data, "basetable")
  expect_s3_class(i1$imputations[[1]], "basetable")
  expect_s3_class(i1$imputed_cells, "basetable")
  ...
  expect_s3_class(complete(i1), "basetable")
  expect_s3_class(complete(i3, "long"), "basetable")
  expect_true(all(vapply(complete(i3, "all"), inherits, logical(1), what = "basetable")))
...
test_that("internal chained equation imputation uses fit/predict steps", {
  ...
  s <- summary(imp)
  expect_s3_class(s$overview, "basetable")
  expect_s3_class(s$variables, "basetable")
  ...
  expect_s3_class(imp$diagnostics$trace, "basetable")
...
test_that("imputer learners expose a standard fit/predict contract", {
  ...
  expect_s3_class(imputer_registry(), "basetable")
...
test_that("evaluate uses amputation truth", {
  ...
  expect_s3_class(e$summary, "basetable")
  expect_s3_class(e$distribution, "basetable")
  expect_s3_class(e$recovery, "basetable")
  expect_s3_class(e$recovery_by_imputation, "basetable")
  expect_s3_class(e$variability, "basetable")
...
test_that("pool estimates and metrics", {
  ...
  expect_s3_class(ps$pooled, "basetable")
  ...
  expect_s3_class(p$pooled, "basetable")
  expect_s3_class(p$data, "basetable")
  ...
  expect_s3_class(pm$pooled, "basetable")
